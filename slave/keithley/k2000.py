...
# TODO: compatibility with nanovoltmeter (k2182) driver.
...
class Initiate(Driver):
    ...
    :ivar continuous_mode: A boolean representing the continuous initiation mode.

    """
    def __init__(self, transport, protocol):
        super(Initiate, self).__init__(transport, protocol)
        self.continuous = self.continuous_mode = Command(
            ':INIT:CONT?',
            ':INIT:CONT',
            Boolean
        )
